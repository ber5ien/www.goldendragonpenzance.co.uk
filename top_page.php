...
<html>
<head>
<title>Golden Dragon - Chinese Food Take Away in Cornwall </title>
  ...
  <script type="text/javascript">
	...
	<STYLE type="text/css">BODY { background: url("graphics/background/background.png") repeat-x }</STYLE>
				 ...
				 <table border=0 align=center style="width: 950px; margin-left: 20px"  cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width=200 valign=top>	
								...
								<div class="content"><center><h2>GOLDEN DRAGON</h2></center></div>
				  					 <div class="subbox">
										<ul>
