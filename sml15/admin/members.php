	...
	<ul id="primary">
		...
		<li><span>Members</span></li>
			<ul id="secondary">
				...
				<li><a href="javascript:doimport_chinese();"><strong>Load Accounts from Golden Dragon</strong></a></li>		
			</ul>
...
<div id="main">			
	<div id="contents">
			<h2>Members</h2>			
			<p class="note">The 'All Members' table lists everyone that has created account on the Golden Dragon Website. Use the search feature below 
...
<table align="center" border="1" bordercolor="#EEEEEE" cellpadding="4" cellspacing="0" style="border-collapse: collapse">
	...
	<tr><td>Golden Dragon Members</td>
