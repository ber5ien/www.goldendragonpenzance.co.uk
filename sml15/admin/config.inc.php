...
$config['db_server'] = "goldendragon.db.6479645.hostedresource.com";

// A user that has access to your database
$config['db_user'] = "goldendragon";

// The password for the user that has access to your database
$config['db_password'] = "dzferzzD313";

// The name of the database
$config['db_name'] = "goldendragon";
...
$config['owner_email'] = "admin@goldendragonpenzance.co.uk";
